# Exploratory plots and anlysis of metapopulation-level resutls generated by 
# pathgrid.shell.r and stored in Output/pathgrid.RData and Output/pathgrid(lattice).RData
