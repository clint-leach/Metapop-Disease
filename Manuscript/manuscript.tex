...
Thus, when high quality habitat is preferentially selected by migrants (i.e. $\xi_em > 0$), high quality habitats form ecological traps, that is, preferentially selected habitat that reduces fitness relative to other habitats \cite{Robertson2006}).
...
Since they are infrequently colonized (when $\xi_em > 0$), the environmental reservoir left behind by these infectious populations likely decays before it has the opportunity to infect new susceptible colonists.  
