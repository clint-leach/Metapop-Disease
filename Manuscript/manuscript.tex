...
\hline
$S \rightarrow I$ & Infection (from contact or reservoir) & $\delta \lambda_{Ii} + \gamma(\tau_i)$\\
$S \rightarrow \emptyset $ & Extinction (of susceptible) & $\epsilon_{Si}$\\
$I \rightarrow \emptyset $ & Extinction (of infectious) &  $\epsilon_{Ii}$ \\
$\emptyset \rightarrow S$ & Colonization (by susceptibles) & $\lambda_{Si}$\\
$\emptyset \rightarrow I$ & Colonization (by infectious) & $\lambda_{Ii}$\\
\label{transitions}
\end{tabular}
\end{table}
...
\begin{equation}
\epsilon_{Xi}=\frac{\mu_X}{A_i^\alpha},
\end{equation}
...
$\mu_I$ & Extinction rate of unity quality infectious patch & 0.5 & -- & -- & --\\
