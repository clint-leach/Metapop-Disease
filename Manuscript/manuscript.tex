...
This model framework demonstrates that environmental longevity increases pathogen persistence and spread.  This agrees both with our intuition -- environmental longevity should provide greater opportunity for transmission -- and with models of chronic wasting disease (\cite{Almberg2011},\cite{Sharp2011}).  \emph{Develop further -- both the papers cited, and other studies including a reservoir.  Remember to highlight not just consistency, but also novelty.}
