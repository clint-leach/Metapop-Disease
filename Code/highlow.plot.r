highlow.plot <- function(conn){
  ...
  lines(seq(20, 200, by = 20), S.occ[, 3], type = "l", lty = 3, pch = 19, col = "black")
  ...
  lines(seq(20, 200, by = 20), I.occ[, 3], type = "l", lty = 3, pch = 19, col = "black")
  ...
  lines(seq(20, 200, by = 20), occ[, 3], type = "l", lty = 3, pch = 19, col = "black")
